...
static void del(GtkWidget *w, gpointer data)
{
	...
	void about(GtkWidget widget, gpointer window)
	{
		...
		gtk_about_dialog_set_comments(GTK_ABOUT_DIALOG(about_dialog), "Nguyễn Đình Minh 20162726\n Phạm Đại Thanh Phong 20167330\n Đặng Trần Quang 20163283\n");
		gtk_about_dialog_set_website(GTK_ABOUT_DIALOG(about_dialog),
			"https://trungtt.com");
		gtk_about_dialog_set_website_label(GTK_ABOUT_DIALOG(about_dialog), "Contact for work.");     
		gtk_about_dialog_set_copyright(GTK_ABOUT_DIALOG(about_dialog), "Nhóm 12 - Việt Nhật A - K61");
